...
A falta de minas na comp é o primeiro sinal de que algo não está muito certo. Você vai perceber que terá poucas mulheres em cada uma das salas da comp; não dá pra ser coincidência né?
...
Os cursos da computação são majoritariamente compostos por homens e, como são da área tecnológica, já vêm vinculados com essa ideia do "ser masculino", que "é" inteligente, racional e lógico. Isto acaba refletindo nas minas de maneira negativa, como se criasse uma atmosfera onde elas não tem espaço, não se sentem parte do meio e acabam tendo experiências ruins.
...
\begin{itemize}
    \begin{minipage}{0.45\textwidth}
    	\item \textbf{Impressão de dificuldade.} É normal se sentir perdido numa turma quando não conhecemos ninguém ou viemos de outra realidade. Mas isso é natural e não deve ser explicado por "ser menina". Portanto, não tem nada a ver achar que as minas tem dificuldades além do normal, e não é legal os colegas se sentirem "os salvadores" por ajudarem em algo.
    \end{minipage}
    \hspace{10px}
    \begin{minipage}{0.5\textwidth}
        \includegraphics[width=0.9\textwidth]{imagens/marta.png}
    \end{minipage}
