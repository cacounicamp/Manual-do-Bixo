...
Pão de Açúcar são muito caros, mas o Pague Menos tem boas promoções de 
...
Existem várias academias no centro de Barão e algumas perto da Unicamp, 
mas se você não tem muita grana ou prefere outros tipos de atividades físicas,
os cursos de extensão da FEF são oferecidos a cada semestre e com um preço mais
em conta do que encontrado em outros lugares. Cursos como pilates, natação, judô,
tênis e muitos outros. Fique atento às datas e horários de incrições! Alguns cursos
ficam sem vagas em minutos! Página dos cursos de extensão: \url{www.fef.unicamp.br/fef/extensao/inscricoes}
