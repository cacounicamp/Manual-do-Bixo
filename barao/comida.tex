...
Devido à onda de fechamentos de cantinas na Unicamp no fim de 2014, causada por
questões burocráticas nas licitações e novas exigências para os equipamentos das
cozinhas, há poucas opções dentro da Unicamp. Entre as cantinas que fecharam
recentemente estão da da Física, a da Química, a da Biologia e a da Educação.

No início de 2015 as opções se resumem à:
...
\begin{itemize}
    \item   \textbf{La Salamandra:} Restaurante mexicano, localizado na Av. 2,
        ...
        %TODO: verificar dois ultimos números
    ...
    \item   \textbf{Vila Ré -- Pizza:} Pizzaria próxima do terminal e do
        ...
        \\Telefone: (19) 3289-0319 %TODO: verificar esse número e 3289 0321
