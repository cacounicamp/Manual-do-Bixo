...
\begin{figure}[htbp!]
    \centering
    \includegraphics[width=\linewidth,trim={0 1cm 0 1cm},clip]{imagens/diagrama_bg.png}
\end{figure}

\subsection{Moradia estudantil gratuita}

\begin{wrapfigure}{1}{0.5\textwidth}
    \includegraphics[width=0.5\textwidth]{imagens/moradia.png}
\end{wrapfigure}
...
A Moradia está localizada na Avenida Santa Isabel, 1125 - a cerca de 3km do campus. E as inscrições para a bolsa moradia e outras bolsas abrem no mês de março para calouros. Não perca datas! Para saber mais sobre a Moradia e o processo seletivo, entre no site \url{https://deape.unicamp.br/permanencia/moradia-estudantil/sobre/}.
