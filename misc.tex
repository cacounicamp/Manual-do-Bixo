...
\begin{itemize}
    ...
    Congregação do IC atualmente são: \textbf{Alex Grilo} (\email{abgrilo@gmail.com}), da
    pós-graduaçao, \textbf{Vinícius Couto} (\email{vinipcouto@gmail.com}), da Engenharia,
    e \textbf{Daniel Pazinato} (\email{danielvatanabe92@gmail.com}) da Ciência.
    ...
    (\email{julia.ramos.beltrao@gmail.com}). Na FEEC, o representante é
    \textbf{Pedro Amorim} (\email{pedrohenrique.a.a@gmail.com}).
    ...
    discentes na CG do IC são: \textbf{Marco Almada} (\email{slawter@gmail.com}), da
    Engenharia, e \textbf{Alexandre Medeiros} (\email{alexandre.n.medeiros@gmail.com}),
