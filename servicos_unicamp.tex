...
e a frequência maior é no horário de almoço. Bom para cobrir boas distâncias
...
pintar alguma dúvida os links estão abaixo:

\begin{itemize}
\item  \textbf{Circular da moradia:}
\begin{itemize}
\item  Horários -- \url{www.prefeitura.unicamp.brprefe/site-novo/Horarios%20circular%20moradia.pdf}
\end{itemize}
\end{itemize}
...
\begin{itemize}
\item  Horários -- \url{www.prefeitura.unicamp.brprefe/site-novo/circular.pdf}
\item  Trajetos -- \url{www.prefeitura.unicamp.brprefe/site-novo/circulartrajeto.pdf}
\end{itemize}
\end{itemize}
