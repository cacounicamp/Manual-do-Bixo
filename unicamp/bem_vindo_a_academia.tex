...
Iniciação Científica. A FAPESP paga em torno de R\$520,00 e aceita pedidos de   % TODO: Conferir valores de bolsas da FAPESP e CNPq
...
semestre, boa parte das disciplinas possuem monitores, que são dividos em dois
tipos: PED (Programa de Estágio Docente) e PAD (Programa de Apoio Didático).

\textbf{PED} é alguém da pós-graduação que é responsável por ajudar * professor
na disciplina, normalmente, criando materiais, exercícios, labs e ajudando na
correção dos mesmos. Já \textbf{PAD} é alguem da graduação e geralmente só é
responsável por ajudar nos labs e com dúvidas, que não deveriam incluir
...
da secretária com um formulário para preencher. % TODO: Maybe adicionar info da FEEC

O programa de PAD costuma incluir uma bolsa que fica em torno de R\$530,00. % TODO: Conferir valor
Os pré-requisitos pra conseguir é (1) ter cursado a disciplina ou alguma
