...
\begin{itemize}
\item Desistência de matrícula em disciplinas (\url{http://bit.ly/1BcBsF4}):
  Processo que é chamado pelos alunos de ``trancamento''.  O aluno não mais
...
\item Cancelamento de matrícula (\url{http://bit.ly/1wQBGCq}): Processo em que o
  aluno se desliga da Unicamp, por motivo de jubilação, por ter faltado às duas
  primeiras semanas do ano de ingresso, por ter sido reprovado em todas as
...
\item Trancamento de matrícula (\url{http://bit.ly/1xWO4SL}): Processo em que o
  aluno não cursa qualquer disciplina da Unicamp durante o semestre. O aluno tem
  direito a fazer até dois trancamentos de matrícula, em semestres seguidos ou
  não e o aluno não pode trancar nenhum dos dois semestres do ano de
  ...
  2/3 do semestre (geralmente de dezembro até fim de maio para trancamento de
  primeiro semestre; e de julho até fim de outubro para trancamento de segundo
...
assegurar todos de que não é associar o aluno à avaliação que ele preencheu.
