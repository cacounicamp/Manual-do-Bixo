...
(\url{http://bit.ly/1BcBsF4}): Processo que é chamado pelos alunos de
``trancamento''.  O aluno não mais cursa essa disciplina no semestre, tendo de
...
metade do semestre.
\subsubsection{Cancelamento de matrícula} (\url{http://bit.ly/1wQBGCq}):
Processo em que o aluno se desliga da Unicamp, por motivo de jubilação, por ter
...
\subsubsection{Trancamento de matrícula} (\url{http://bit.ly/1xWO4SL}): Processo
em que o aluno não cursa qualquer disciplina da Unicamp durante o semestre. O
aluno tem direito a fazer até dois trancamentos de matrícula, em semestres
seguidos ou não e o aluno não pode trancar nenhum dos dois semestres do ano de
