...
\begin{itemize}
    ...
    \item  \textbf{Congregação:} É o órgão colegiado máximo do instituto ou
        ...
        \textbf{Alex Grilo} (\email{abgrilo@gmail.com}), da pós-graduaçao,
        \textbf{Vinícius Couto} (\email{vinipcouto@gmail.com}) e \textbf{Daniel
        Pazinato} (\email{danielvatanabe92@gmail.com}), da Engenharia.
    ...
    \item  \textbf{CI (Conselho Interedepartamental):} Este é um ``braço'' da
        ...
        Beltrão} (\email{julia.ramos.beltrao@gmail.com}). Na FEEC, o
        representante é \textbf{Pedro Amorim}
        (\email{pedrohenrique.a.a@gmail.com}).
    ...
    \item  \textbf{CG (Coordenadoria/Comissão de Graduação):} É o órgão da
        ...
        Almada} (\email{almadamarcol@gmail.com}), da Engenharia, e
        \textbf{Alexandre Medeiros} (\email{alexandre.n.medeiros@gmail.com}), da
        Ciência. Na FEEC, o representante atual é \textbf{Brunno R. Arangues}
        (\email{tomate.brunno@gmail.com}).
    ...
    \item  \textbf{DAC (Diretoria Acadêmica):} É o órgão executivo e
        ...
        \begin{figure*}[hb!]
            \centering
            \includegraphics[scale=1.1, keepaspectratio=true]{img/mapa_siglas.pdf}
    ...
    \item  \textbf{SAE (Serviço de Apoio ao Estudante):} É encarregado da
        execução de programas de assistência desenvolvidas pela Universidade,
        por iniciativa própria ou mediante convênios firmados com entidades
        especializadas.

    \item  \textbf{Crédito:} Unidade elementar de horas-aula de qualquer curso
        da Unicamp. Um crédito equivale a uma hora-aula semanal, ou a 15
        horas-aula semestrais.

    \item  \textbf{Período letivo:} É um nome complicado para se referir ao
        semestre.

    \item  \textbf{Currículo pleno:} É o conjunto de disciplinas do curso que o
