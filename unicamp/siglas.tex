...
\begin{itemize}
    ...
    \item  \textbf{Congregação:} É o órgão colegiado máximo do instituto ou
        ...
        \textbf{Caio Hoffman} (\email{caiohoffman@gmail.com}), da pós-graduaçao,
        \textbf{Victor Pompêo} (\email{victorfpb@gmail.com}) e \textbf{Gérson
        Carlos} (\email{gerson.mtg@gmail.com}), da Engenharia.
    ...
    \item  \textbf{CI (Conselho Interdepartamental):} Este é um ``braço'' da
        ...
        Rolfsen} (\email{gabriel.rolfsen@gmail.com}). Na FEEC, o representante
    ...
    \item  \textbf{CG (Coordenadoria/Comissão de Graduação):} É o órgão da
        ...
        Beltrão} (\email{julia.ramos.beltrao@gmail.com}), da Engenharia, e
        \textbf{Yuri Soares} (\email{yuricorreapinto@gmail.com}), da
