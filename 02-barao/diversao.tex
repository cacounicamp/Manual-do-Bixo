...
acadêmica? Como em toda universidade, na Unicamp existem inúmeras opções de
entretenimento e diversão, desde festas e bares até cinemas e teatros.
...
comida e bebida são um pouco caras, mas mesmo assim compensa. Se você não sabe
o que jogar, peça sugestões aos garçons de jogos.
...
\begin{itemize}
    \item   \textbf{Kinoplex}
        \\Endereço: Shopping D. Pedro (Rodovia Dom Pedro I, Km 137 -- Jd. Sta.
        Genebra)
...
\begin{itemize}
    ...
    \item   \textbf{Ventura Mall:} Shopping pequeno, porém as lojas são muito
    caras.
