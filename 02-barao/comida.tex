...
críticas com relação a variedade. Além do prato principal, há também a disposição
de uma sobremesa a esse público.
...
cardápio consiste de café, leite, pão, manteiga e a cada dia há uma geleia e fruta
...
\item \textbf{Cantina do DCE}
  ...
  seu próprio cachorro-quente à kg no período da noite, com recheios como salsicha 
  comum, salsicha vegetariana, purê de batata, batata palha, strogonoff, arroz, etc. 
...
\item \textbf{Cantina da Biologia}
  \\Próximo ao CB, possui self-service, marmita, lanches, pizza, etc. É o que oferece
  maior diversidade em seu cardápio.
...
\item \textbf{Banca de sucos do CB}
  ...
  \\O pessoal que atende lá costuma ser muito simpático. Se possível, retribua isso!

\item \textbf{Gatti}
  \\Fica do lado do IC-2, na Cênicas/Dança.
  \\Se você é vegetariana, é uma boa dica. Apenas lembre-se de levar dinheiro, pois
  não aceitam cartão.

\item \textbf{Cantina da Educação}
  \\Também ao lado do IC-2, tem self-service, lanches, yakissoba, tortas, etc. É o mais 
  próximo para quando quiser fugir dos salgados ordinários.
...
\item \textbf{Cantina da Mecânica}
  ...
  com pão na chapa matinal. Update: No momento da publicação, não temos certeza se a
  cantina encontra-se disponível. Vale a viagem para descobrir!

\item \textbf{Cantina da FEA/FEM}
  \\Mais uma que até então encontra sem ninguém utilizando o ponto. Mais sorte na próxima,
  bix*.
...
R\$ 12, mata sua fome até 18h30. (Preço talvez defasado)

Vale a pena ir ao menos uma vez para encarar as opções. Há yakissoba, pastel, açaí,
strogonoff, pratão de comida saudável/vegetariana show, raspadinha, etc. A boa é sair
depois daquela sua aula de cálculo ou física depressiva e se dar esse ânimo ou quando
precisa fugir do bom e constante cozido misto do bandejão.
...
um tamanho satisfatório e custa R\$ 15,75, bem mais em conta que o self-service) e, 
mais para cima na avenida, há o Yaki-Ten (comida chinesa por quilo, japonesa por 
pessoa).
...
cara. Vale a pena se for no almoço ou na madrugada para aproveitar seus buffets,
que são bem gostosos e compensam se for com pelo menos mais uma pessoa).\\
