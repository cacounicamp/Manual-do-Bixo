...
máquinas só aceitam notas e não existe troco. Para cédulas de cem e cinquenta
reais, apenas uma máquina no RU aceita.
...
branco, torta de aveia, entre outros, mas não se anime muito, há várias críticas
com relação a variedade. Além do prato principal, há também a disposição de uma
sobremesa única às vegetarianas e aos vegetarianos.
...
O preço é R\$ 2,00 depois do aumento de 2017 (era apenas 1 real, então
dependendo do que você come, não vale mais a pena tomar café da manhã no RU). O
cardápio consiste de café, leite, pão, manteiga e uma combinação que muda
diariamente de geleia e fruta. Divirta-se com suas amigas e amigos tentando
advinhar qual será a geleia do dia!
...
\begin{itemize}
\item \textbf{Cantina do DCE}
  \\Nela há tapiocas, sanduíches, almoço self-service e também a opção de montar
  seu próprio cachorro-quente à kg no período da noite, com recheios como
  salsicha comum, salsicha vegetariana, purê de batata, batata palha,
  strogonoff, arroz etc.
  \\Acreditamos que o arroz é para o caso de alguém montar seu pratão.

\item \textbf{Cantina da Física}
  \\Em 2018 ela fechou, não sabemos se até o momento da sua leitura a cantina
  estará novamente disponível.

\item \textbf{Cantina da Biologia}
  \\Próximo ao CB, possui self-service, marmita, lanches, pizza etc. É a que
  oferece maior diversidade em seu cardápio.

\item \textbf{Cantina da Química}
  \\Próximo ao CB, possui prato-feito e abre também aos sábados.
...
\item \textbf{Banca de sucos do CB}
  ...
  \\O pessoal que atende lá costuma ser muito simpático. Retribua essa simpatia!

\item \textbf{Gatti}
  \\Fica do lado do IC-2, na Cênicas/Dança.
  \\Se você é vegetariana, é uma boa dica. Apenas lembre-se de levar dinheiro,
  pois não aceitam cartão.

\item \textbf{Cantina da Educação}
  \\Também ao lado do IC-2, tem self-service, lanches, yakissoba, tortas etc.
  É o mais próximo para quando quiser fugir dos salgados ordinários.

\item \textbf{Cantina da Economia}
  \\Ao outro lado do IC-2, tem bons lanches.

\item \textbf{Cantina da Mecânica}
  \\Fica próximo à FEEC, abre bem cedo, serve o bom pingado (café com leite) com
  pão na chapa matinal.
  \\Em 2018, ela também fechou, então pode não estar aberta no momento de
  leitura.
\end{itemize}
...
sanduiches muito bem feitos, é um pouco caro. Ou o strogonoff, que custa cerca
de R\$ 13,00 e até o tamanho pequeno é generoso.

Vale a pena ir ao menos uma vez para encarar as opções. Há yakissoba, pastel,
açaí, strogonoff, pratão de comida saudável/vegetariana show, raspadinha etc. A
boa é sair depois daquela sua aula de cálculo ou física depressiva e se dar esse
ânimo ou quando precisa fugir do bom e constante cozido misto do bandejão.
...
cara), que vale a pena se for no almoço ou na madrugada para aproveitar seus
buffets, que são bem gostosos e compensam se for com pelo menos mais uma
pessoa).\\
...
\item \textbf{Açaí da Barra}
  ...
  \\
  \\Açaí e sorvetes por quilograma com várias opções de recheios. como doces e
