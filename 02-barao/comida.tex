...
\item \textbf{Maria Gasolina}
	...
	hambúrgueres, sucos, saladas, omeletes e panquecas. Tem também opções
	de salgados e café da manhã.
\end{itemize}
...
\item \textbf{Maria Bonjour}
	...
	\\Horário de Funcionamento: De terça à sábado das 18h à 01h.
	De domingo das 18h às 23h30.
	\\
	\\Tem um cardápio muito bom de lanches e de cervejas. Tem muitos horários com
	cardápio especial de happy hour - terça, quarta e domingo durante toda a noite
	e quinta e sexta até às 20h30. É comum ter shows ao vivo de jazz por professores
	da UNICAMP - do Instituto de Artes - e convidados.
...
\item \textbf{Ponto da Esfiha}
	...
	\\Oferece bastante opções de esfihas abertas, fechadas e salgados.
	Fica bem no começo da Avenida 1, no entroncamento com a Av. Albino.
	Preço bom.
...
\item \textbf{Auto Lanche Bigode}
	...
	\\
	\\Fica bem na entrada de Barão, depois do Estância Grill.
	Tem ótimas opções de lanches muito bem feitos e com preços bons
\end{itemize}
...
\item \textbf{Cervejaria Tábuas}
	...
	artesanais de fabricação própria e de convidados. As opções de comida
	variam bastante de acordo com o dia e com food trucks que eles convidam
	para servir. Vale a pena dar uma consultada na página deles no Facebook
	e verificar a programação da semana. O preço é meio alto mas as cervejas
	são boas.
\end{itemize}
