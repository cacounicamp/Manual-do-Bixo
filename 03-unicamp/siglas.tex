...
\item \textbf{Gustavo Vilas Boas}
  \\(\email{g198625@dac.unicamp.br}) e
\item \textbf{Victor Toon de Araújo}
  \\(\email{araujo.victor200@gmail.com}).
\end{compactitemize}
...
Ferrari} (\email{vferrari@mpc.com.br}).
=======
...
>>>>>>> 5b2af232a02c120275486cd6f438732054ec11c5
...
\item \textbf{Francisco Namias Vicente} (engenharia, 
  \\ \email{francisconavy@yahoo.com.br}).
\end{compactitemize}
...
\item \textbf{Alberto Matheus Kudo Barros}
  \\ (\email{matheuskbarros1@gmail.com}) e
\item \textbf{Manuela Rafael Onofre de Sousa}
  \\ (\email{manuelaonofre1326@gmail.com}).
\end{compactitemize}
