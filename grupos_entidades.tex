...
\begin{figure}[h!]
    \vspace{-10pt}
    \centering
    \includegraphics[scale=0.22, keepaspectratio=true]{img/imgs/21-CACo/caco.jpg}
    \vspace{-10pt}
\end{figure}
...
Veja abaixo algumas das atividades que o CACo pratica:
...
importante, afinal somos nós que ganhamos e perdemos com o bom e o ruim de
...
ótima e barata maneira de ir e tembém socializar com outros computeiros.
...
PipoCACos sobre cotas, sobre o ENADE e semestralmente fazemos o PipoCACo de
Avaliação de Curso, onde reunímos as reclamações dos alunos para a reunião de
...
O curso de Engenharia de Computação da Unicamp se divide em duas modalidades: AA
e AB. A diferença? Ninguém sabe ao certo. Por isso, o CACo organiza uma série de
...
\begin{figure}[h!]
    \vspace{0pt}
    \centering
    \includegraphics[scale=0.2, keepaspectratio=true]{img/imgs/21-CACo/pokeriv.jpg}
    \vspace{-10pt}
\end{figure}
...
comprar nossos produtos, se increver em algum de nossos eventos ou só bater papo
com a gente mesmo. Os horários de atendimento serão divulgados no início do
semestre e você pode conferí-los no site do CACo.
...
Centro Acadêmico. Você e toda a computação também faz parte do CACo e tem papel
...
\begin{figure}[t!]
    \centering
    \includegraphics[scale=0.42, keepaspectratio=true]{img/imgs/21-CACo/reuniao.jpg}
\end{figure}
